...
const SearchBar = ({className}) => {
    ...
    return (
        <div className={'flex w-300 rounded bg-white ' + className}>
            <input className="w-300 border-none bg-transparent px-4 pr-2 py-1 text-gray-400 outline-none focus:outline-none " type="search" name="search" placeholder="Search..." />
